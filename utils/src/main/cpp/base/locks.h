...
class Locks {
 public:
  static void Init();
  static void InitConditions();  // Condition variables.
  ...
  static void SetClientCallback(ClientCallback* is_safe_to_call_abort_cb);
  ...
  //  .. running ..                                |  .. running ..
  static MutatorMutex* mutator_lock_;
  ...
  static Mutex* deoptimization_lock_;
  ...
  static Mutex* subtype_check_lock_;
  ...
  static ConditionVariable* thread_exit_cond_;

  // Guards maintaining loading library data structures.
  static Mutex* jni_libraries_lock_;

  // Guards breakpoints.
  static ReaderWriterMutex* breakpoint_lock_;
  ...
  static Mutex* allocated_monitor_ids_lock_;

  // Guard the allocation/deallocation of thread ids.
  static Mutex* allocated_thread_ids_lock_;

  // Guards modification of the LDT on x86.
  static Mutex* modify_ldt_lock_;

  static ReaderWriterMutex* dex_lock_;

  // Guards opened oat files in OatFileManager.
  static ReaderWriterMutex* oat_file_manager_lock_;

  // Guards extra string entries for VerifierDeps.
  static ReaderWriterMutex* verifier_deps_lock_;

  // Guards dlopen_handles_ in DlOpenOatFile.
  static Mutex* host_dlopen_handles_lock_;

  // Guards intern table.
  static Mutex* intern_table_lock_;

  // Guards reference processor.
  static Mutex* reference_processor_lock_;

  // Guards cleared references queue.
  static Mutex* reference_queue_cleared_references_lock_;
  ...
  static ReaderWriterMutex* jni_globals_lock_;

  // Guard accesses to the JNI Weak Global Reference table.
  static Mutex* jni_weak_globals_lock_;

  // Guard accesses to the JNI function table override.
  static Mutex* jni_function_table_lock_;
  ...
  static Mutex* custom_tls_lock_;

  // Guards Class Hierarchy Analysis (CHA).
  static Mutex* cha_lock_;
  ...
  static Mutex* native_debug_interface_lock_;

  // Have an exclusive logging thread.
  static Mutex* logging_lock_;
